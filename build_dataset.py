...
def build_dataset(datasetname, charlevel=True, min_freq=None):
    '''
        ...
        for i, filename in enumerate(filenames):
            ...
            for line in lines:
                ...
                for word in words: # word is cut as correct group of syllables
                    ...
                    if datasetname in ['ch_1', 'bi_1', 'bict_1', 'bisy_1', 'chctbi_1', 'bictsy_1']: # scheme BI
                    ...
                    elif datasetname in ['bi_12345', 'bict_12345', 'bisy_12345']: # scheme D
                    ...
                    elif datasetname in ['bictsy_12345']: # not good, must change or delete
                    ...
                    elif datasetname == 'sy_1': # scheme BI

                        if len(syllables_ofword) > 0: # for sure
                            labels_ofword = ['I1'] * len(syllables_ofword) # all labels is 'I1'
                            labels_ofword[0] = 'B1' # except that first labels is 'B1'
                            
                    elif datasetname == 'sy_1-23-45': # scheme A
                    ...
                    elif datasetname == 'sy_1234': # scheme B
                    ...
                    elif datasetname == 'sy_12345': # scheme C
                ...
                if datasetname[:3] == 'sy_': dataset.append((syllables_ofline, labels_ofline))
                elif datasetname in ['ch_1']: dataset.append((chars_ofline, labels_ofline))
                elif datasetname in ['bi_1', 'bi_12345']: dataset.append((bigrams_ofline, labels_ofline))
                elif datasetname in ['bict_1', 'bict_12345']: dataset.append((bigrams_ofline, chartypes_ofline, labels_ofline))
                elif datasetname in ['bisy_1', 'bisy_12345']: dataset.append((bigrams_ofline, syllables_ofline, labels_ofline))
                elif datasetname in ['chctbi_1']: dataset.append((chars_ofline, chartypes_ofline, bigrams_ofline, labels_ofline))
                elif datasetname in ['bictsy_1', 'bictsy_12345']: dataset.append((bigrams_ofline, chartypes_ofline, syllables_ofline, labels_ofline))
                
            show_progress(i, onetenth) # for tracking progress
                
        with open('dataset/' + datasetname + '_' + directory + '.json', 'w') as file:
            json.dump(dataset, file)
            print('', datasetname + '_' + directory, 'length =', len(dataset))
